<?php
/*
Template Name: ConstructZilla : Construction, Renovation & Building HTML Template With
...
/* ReCaptch Secret */
$recaptchaSecret = '<!-- Put reCaptcha Site Key -->';
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			$dzMailSubject = 'ConstructZilla|Appointment Form: A Person want to contact';
			$dzMailMessage	= 	"
								A person want to contact you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>".$dzPhoneMessage."
